...
class MakeAppointment2 extends StatefulWidget {
  ...
  @override
  State<MakeAppointment2> createState() => _MakeAppointment2State();
}

class _MakeAppointment2State extends State<MakeAppointment2> {
